...
def get_subset_statistics(df, assessment):
    ...
    print("---------------------------------------------")
    print("Number of unique patients: ", df.patid.nunique())
    print("  ")
...
#    rapid3 = ['rapid3', 'rapid 3', 'rapid-3', 'rapid3/mdhaq']
    ...
    pro_scores.to_parquet(HP.path_data + '%s_scores_processed.parquet' % HP.assessment)
